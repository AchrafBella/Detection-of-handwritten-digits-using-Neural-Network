...
class Neural():
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learningRate, activation_function, derive_function):
        ...
        self.weights1 = np.random.normal(0.0, pow(self.hidden_nodes, -0.5), (self.input_nodes, self.hidden_nodes))
        self.weights2 = np.random.normal(0.0, pow(self.output_nodes, -0.5), (self.hidden_nodes, self.output_nodes))
    ...
    def fit(self, x_train, y_train, epochs):
        ...
        for e in range(epochs):
            ...
            self.weights2 +=  self.learningRate * np.dot(hidden_layer.T, modification2)
        pass
